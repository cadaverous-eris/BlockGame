...
namespace eng {
    ...
    void GuiAbstractSlider::render(float) {
        const bool doHighlight = isDragging || isHovered();
        ...
        gui->drawImage(thumbPos, thumbSize, { 48, 132 }, { 256, 256 });
        ...
        const Color textColor = (doHighlight ? color::gold : color::lightgray);
